...
const MyEvent: React.FC = () => {
  ...
  const fetchData = () => {
    ...
    request.get(`events?type=${eventType}`).then((result: any) => {
      if (result.err) {
              ...
              <IonRow key={index}>
                <IonCol>
                  <IonCard
                    ...
                    style={{ background: index % 2 ? "#fff" : "#eee" }}
                  >
                    <IonCardContent className="event-content">
                      <IonGrid
                        className={
                          index % 2 ? "even-event events" : "odd-event events"
                        }
                        onClick={() =>
                          history.push("/my/eventdetails?id=" + i.id)
                        }
                      >
                        ...
                        <IonRow className="start">
                          <p>Time:</p>
                          <IonCol>
                            {moment(i.event_at).format("hh:mm a")}
                          </IonCol>
                        </IonRow>
                      </IonGrid>
                      ...
                      >
                        ...
                        <img
                          ...
                          onClick={() =>
                            history.push(
                              `/my/createeventtask?id=${i.id}&eventName=${i.name}`
                            )
                          }
                        />
                        <img
